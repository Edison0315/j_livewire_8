    ...
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div class="p-8 bg-gray-200 col-span-1">
            <ul class="flex flex-col">
                <li class="font-medium text-sm text-gray-400 mb-4 uppercase">Contenido</li>
        ...
        <div class="text-gray-700 col-span-2">
            <img src="{{ $course->image }}" alt="Imagen">
            <h2 class="text-4xl">{{ $course->name }}</h2>
            <p>{{ $course->description }}</p>
            <div class="flex mt-3">
                <img src="{{ $course->user->avatar }}" alt="Imagen usuario" class="h-10 w-10 rounded-full mr-2">
                <div>
